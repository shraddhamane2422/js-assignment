let image = document.getElementById("imageleft")
  let info = document.getElementById("info")
  let selectedImage = "image0"
var productData = {
    "id": "1",
    "name": "Men Navy Blue Solid Sweatshirt",
    "preview": "https://assets.myntassets.com/h_1440,q_100,w_1080/v1/assets/imagelefts/7579188/2018/11/5/08a7b230-ee8f-46c0-a945-4e835a3c01c01541402833619-United-Colors-of-Benetton-Men-Sweatshirts-1271541402833444-1.jpg",
    "photos": [
  ...
  imageleft.innerHTML += `<img src=${productData.preview} class = "leftPreview" id="previewImage"/>`
...
info.innerHTML += `<button id="btn">Add to Cart</button>`
